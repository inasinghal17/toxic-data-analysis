...
clf.fit(x_train,y_train)
print(x_train.shape)
print("for insult:",clf.score(x_test,y_test))
...
clf.fit(x_train,y_train)
print(x_train.shape)
print("for identity_hate:",clf.score(x_test,y_test))
